...
export const metadata = {
  title: 'RivalEdge vs AlphaSense: A Side-by-Side Comparison — RivalEdge',
  description: 'Enterprise market intelligence vs startup-friendly competitive intelligence. See the 100x price difference.',
};
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <article className="max-w-4xl mx-auto px-6 pt-12 pb-20">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="text-left py-3">AlphaSense</th>
                </tr>
              </thead>
              <tbody className="text-slate-300">
                <tr className="border-b border-slate-800"><td className="py-3 pr-4 font-medium text-white">Starting Price</td><td className="py-3 pr-4">$49/month</td><td className="py-3">$5,000+/year</td></tr>
                ...
                <tr className="border-b border-slate-800"><td className="py-3 pr-4 font-medium text-white">Document Search</td><td className="py-3 pr-4">❌ No</td><td className="py-3">✅ Yes (10K+ sources)</td></tr>
                <tr className="border-b border-slate-800"><td className="py-3 pr-4 font-medium text-white">AI-Generated Reports</td><td className="py-3 pr-4">✅ Yes</td><td className="py-3">✅ Yes</td></tr>
                ...
                <tr className="border-b border-slate-800"><td className="py-3 pr-4 font-medium text-white">Self-Serve</td><td className="py-3 pr-4">✅ Yes</td><td className="py-3">❌ No</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-6 mb-8">
          ...
          <p className="text-slate-300 mb-4">AlphaSense is for investment firms and enterprises that need to search through earnings calls, SEC filings, and research reports.</p>
          <p className="text-slate-300 mb-4">RivalEdge is for startups and SMBs that need to track competitor websites, pricing, and market positioning.</p>
          <p className="text-white font-medium">If you're not analyzing earnings calls, RivalEdge gives you what you need at 1/100th the price.</p>
        </div>
